  ...
  <div class="optimize_box">
    <div class="box_head">
      <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
        <el-tab-pane label="航速优化" :name="0"></el-tab-pane>
        <el-tab-pane label="吃水差优化" :name="1"></el-tab-pane>
        <el-tab-pane label="燃料替代计算" :name="2"></el-tab-pane>
        <el-tab-pane label="CIl计算器" :name="3"></el-tab-pane>
      </el-tabs>
    </div>
    <div class="pane_box">
      <div class="search_box flex-row align-center">
        <p class="lebal_text">时间期间</p>
        <el-date-picker v-model="startDate" value-format="YYYY-MM-DD" clearable="false" type="date" placeholder="请选择"
          :size="size" />
        <span class="lebal_text">-</span>
        <el-date-picker v-model="endDate" clearable="false" value-format="YYYY-MM-DD" type="date" placeholder="请选择"
          :size="size" />

        <p class="btn_color" @click="search">
          搜索
        </p>
      ...
      <div class="data_box">
        <div class="data_head flex-row align-center justify-between">
          ...
          <div class="head_right flex-row align-center">
            <div v-for="item in iconArr" :key="item.id" :class="{ active: item.id == selectType }"
        ...
        <div v-if="selectType == 'table'" class="date">
          <el-table v-if="selectType == 'table'" :data="tableData" stripe size="large" max-height="400px">
            <el-table-column label="序号" align="center" type="index" />
            <el-table-column prop="speed_water" align="center" label="年均对水航速" />
            <el-table-column prop="delta" align="center" label="对水航速差值" />
            <el-table-column prop="gross_ton" align="center" label="年均主机每海里消耗" />
            <el-table-column prop="consumption" align="center" label="节省燃料" />

            <el-table-column prop="cii" label="CII" align="center" />
            <el-table-column prop="grade" align="center" label="CII评级">
        ...
        <div v-if="selectType == 'echart'" class="echart_box">
          <div id="chart1"></div>
        </div>
      </div>
    </div>
